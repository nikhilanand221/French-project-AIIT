			...
			>
				...
				<View style={styles.section}>
					...
					<LessonCard
						...
						type="vocabulary"
						completed={
							getLessonProgress("vocabulary-greetings")?.completed || false
						}
						progress={getLessonProgress("vocabulary-greetings")?.score || 0}
						onPress={() => handleLessonPress("vocabulary", "1")}
					/>
					<LessonCard
						title="Grammaire"
						...
						type="grammar"
						completed={
							getLessonProgress("vocabulary-grammar")?.completed || false
						}
						progress={getLessonProgress("vocabulary-grammar")?.score || 0}
						onPress={() => handleLessonPress("vocabulary", "2")}
					/>{" "}
					<LessonCard
						title="Exercices"
						...
						onPress={() => handleLessonPress("exercises", "1")}
					/>
					<LessonCard
						title="Jeux"
						subtitle="Jeux amusants pour renforcer l'apprentissage"
						type="games"
						completed={getLessonProgress("games-matching")?.completed || false}
						progress={getLessonProgress("games-matching")?.score || 0}
						onPress={() => handleLessonPress("games", "1")}
					/>
					<LessonCard
						title="Évaluation"
